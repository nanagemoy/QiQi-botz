...
global.dfail = (type, m, conn) => {
    let imgr = 'https://telegra.ph/file/61ce23c9822dcb6f56f9d.jpg'
    let msg = {
...
renderLargerThumbnail: true
    ...
    let msgg = {
        unreg: `ʜᴇʟʟᴏ @${m.sender.split("@")[0]} sɪʟᴀʜᴋᴀɴ ᴅᴀғᴛᴀʀ ᴋᴇ *ᴅᴀᴛᴀʙᴀsᴇ* ʙᴏᴛ ᴛᴇʀʟᴇʙɪʜ ᴅᴀʜᴜʟᴜ ᴊɪᴋᴀ ɪɴɢɪɴ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ғɪᴛᴜʀ !
