...
let ppUrl = await conn.profilePictureUrl(who, 'image').catch((_) => "https://telegra.ph/file/e6087909565eceff9bee1.jpg");
...
*BOT AKAN OTOMATIS KLUAR 📤 DARI GRUB DALAM KURANG WAKTU 12 - 20 mnt JIKA INGIN MEMPERPANJANG BOT HUBUNGIN OWNER, THANKS* 
\n\n* THE BOT WILL AUTOMATICALLY EXIT 📤 FROM THE GROUP IN LESS 12 - 20 minutes IF YOU WANT TO EXTEND THE BOT CONTACT THE OWNER, THANKS *`
...
title: ` 𝐿yosh 🎩`,
thumbnailUrl: "https://telegra.ph/file/e6087909565eceff9bee1.jpg",
sourceUrl: gcbot,
mediaType: 1,
renderLargerThumbnail: true
}}}, { quoted: m})
}
handler.customPrefix = /^(.perpanjang)$/i
