let handler = async (m, { conn }) => {
    ...
    if (new Date - global.db.data.users[m.sender].lastberburu > 3600000) {
        let randomaku1 = `${Math.floor(Math.random() * 0,2)}`
        let randomaku2 = `${Math.floor(Math.random() * 2)}`
        let randomaku4 = `${Math.floor(Math.random() * 3)}`
        let randomaku3 = `${Math.floor(Math.random() * 3)}`
        let randomaku5 = `${Math.floor(Math.random() * 1)}`
        let randomaku6 = `${Math.floor(Math.random() * 1)}`
        let randomaku7 = `${Math.floor(Math.random() * 2)}`
        let randomaku8 = `${Math.floor(Math.random() * 3)}`
        let randomaku9 = `${Math.floor(Math.random() * 4)}`
        let randomaku10 = `${Math.floor(Math.random() * 4)}`
        let randomaku11 = `${Math.floor(Math.random() * 2)}`
