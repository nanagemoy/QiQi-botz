...
let handler = async (m, { conn, args, text, usedPrefix, command, isROwner }) => {
    let _p = usedPrefix
    const linkgc = 'https://chat.whatsapp.com/KsflYNKrlNP1BnLMKyulz'
    const domain = 'https://panel.lyoshserver.my.id'
    const apikey = 'ptla_FQtiYcJ179Gl51fZvpJfkzmgr7GkvRQu2OsNH7lcjW7'
    const c_apikey = 'ptlc_N6aJ7hxIT0sKBf43P88mqIIC6Gx8YwV4pPyFF92Oo2e'
    switch (command) {
        case 'addusr': {
